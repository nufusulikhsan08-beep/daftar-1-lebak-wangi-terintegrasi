...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('schools.students.import', $school->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="alert alert-info">
                        ...
                        <br><br>
                        <a href="{{ route('schools.students.export', $school->id) }}" class="btn btn-success btn-sm">
